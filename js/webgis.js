...
// --- GeoServer WMS Layers (our data) ---
const GEOSERVER = 'http://localhost:8088/geoserver';
const WORKSPACE = 'gis_lab_group2';

function createWMSLayer(name, title, visible, opacity) {
    return new ol.layer.Tile({
        title: title, visible: visible, opacity: opacity || 0.85,
...
const map = new ol.Map({
    target: 'map',
    layers: [osmLayer, cartoLayer, satelliteLayer, bivariateLayer, provinceLayer, dissolvedLayer, amacLayer, lccLayer],
    view: new ol.View({
